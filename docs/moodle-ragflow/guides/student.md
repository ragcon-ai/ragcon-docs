...
From the documents your teacher added to the tutor's knowledge base (or the search dataset) — not from a
general chatbot. That's why answers are specific to your course.

**Is my chat private?**
The conversation is handled by your site's RAGflow service. Depending on how your site is configured, it
may be remembered to give better follow-up answers. If a **private mode** is offered, use it to avoid
storing durable facts about you. Ask your administrator about your institution's data policy.

**Why didn't the tutor answer my question?**
Either the document with the answer isn't in the knowledge base yet, or it's still being processed. Try
again later or ask your teacher to add the material.
